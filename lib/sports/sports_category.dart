...
import 'package:tickets_reservation/fotball/football_screen.dart';

class SportsCatScreen extends StatelessWidget {
                    ...
                    child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Football',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.w500),)
                          ],
                        )
                    ),
                    ...
                    child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Basketball',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.w500),)
                          ],
                        )
                    ),
                    ...
                    child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Handball',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.w500),)
                          ],
                        )
                    ),
                  ),
                    ...
                    child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Volleyball',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.w500),)
                          ],
                        )
                    ),
                  ),
